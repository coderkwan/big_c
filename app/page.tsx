...
export default function Home() {
    ...
    return (
        <main>
            <div className="max-w-[1200px] mx-auto px-6 mb-[10rem] flex flex-col md:flex-row gap-[4rem justify-between gap-5 items-center my-[5rem]">
                <div className=" md:w-[60%] flex flex-col gap-4  max-w-[600px]">
                    <h1 className="text-3xl md:text-4xl font-bold">{titles[count]}</h1>
                ...
                <div className="w-full p-4 bg-black md:w-[40%] flex flex-col items-center justify-start md:justify-center">
                    <img
                        ...
                        alt="printing"
                    />
                    <p className="bg-black text-slate-100 p-3 uppercase w-full text-center">{images[count_img]["name"]}</p>
                </div>
            </div>
            <section className=" max-w-[1200px] mx-auto my-[10rem] px-6 flex flex-col gap-4 items-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        ...
                        <button className="bg-orange-500 text-slate-300  p-3">View deltails on Signage Printing</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <div className="px-6">
                            <h3 className="text-xl text-slate-800 font-bold">Printing Materials</h3>
                            <p className="text-slate-600">We supply high quality printing materials.</p>
                        </div>
                        <button className="bg-slate-800 text-slate-300  p-3">View deltails on Printing Materials</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <button className="bg-orange-500 text-slate-300  p-3">View deltails on Vihicle Branding</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <div className="px-6">
                            <h3 className="text-xl text-slate-800 font-bold">DTF Printing</h3>
                            <p className="text-slate-600">Print vibrant, high-quality designs on fabrics with Direct-to-Film (DTF) printing.</p>
                        </div>
                        <button className="bg-slate-800 text-slate-300  p-3">View deltails on DTF Printing</button>
                    </div><div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <button className="bg-orange-500 text-slate-300  p-3">View deltails on Road Signs</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl text-slate-800 font-bold">3D Fabrication</h3>
                            <p className="text-slate-600">Bring your ideas to life with custom 3D fabrication for signage, displays, and prototypes.</p>
                        </div>
                        <button className="bg-slate-800 text-slate-300  p-3">View deltails on Signage Printing</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <button className="bg-orange-500 text-slate-300  p-3">View deltails on Large Format Printing</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <div className="p-6">
                            <h3 className="text-xl text-slate-800 font-bold">UV Printing</h3>
                            <p className="text-slate-600">Print sharp, durable designs on various materials with high-quality UV printing technology.</p>
                        </div>
                        <button className="bg-slate-800 text-slate-300  p-3">View deltails on UV Printing</button>
                    </div>
                    <div className="flex flex-col justify-between border border-slate-300 gap-5 ">
                        <div className="relative w-full h-[300px]">
                        ...
                        <button className="bg-orange-500 text-slate-300  p-3">View deltails on Sublimation</button>
                    </div>
                </div>
            </section>
            ...
            <section className="mt-[10rem]  py-[3rem] px-[1rem] md:p-[5rem] bg-slate-800 text-slate-200 text-center flex flex-col gap-4 items-center">
